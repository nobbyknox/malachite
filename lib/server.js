...
app.post('/bookmarks', function(req, res) {
    ...
    var bookmarkModel = req.body;
    bookmarkModel.userId = req.query.__userId;

    dataStore.create(models.BookmarkModel, bookmarkModel, function(err) {
        if (err) {
            res.status(constants.HTTP_INVALID_ENTITY).send(err);
        } else {
...
app.post('/tags', function(req, res) {
    ...
    // TODO: Inject user ID in payload
