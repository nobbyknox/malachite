...
app.get('/system/nothumbs', function(req, res) {
    ...
    //// TODO: Add thumbnail and limit values to config
    //var options = {
    //    where: { 'thumb': 'blank.png' },
    //    orWhere: { 'thumb': null },
    //    related: ['meta'],
    //    limit: 2
    //    //'join': {
    ...
    //    //    'on': ['bookmarks.id', '=', 'bookmarks_meta.bookmarkId'],
    //    //    'andOn': [
    //    //        ['bookmarks_meta.attr', '=', constants.BOOKMARK_ATTR_THUMB_UNREACHABLE],
    //    //        ['bookmarks_meta.value', '<>', '1']]
    //    //}
    //
    //};
    //
    ...
    //    } else {
    //
    //        //log.debug(bookmarks.meta);
    //        //bookmarks[0].meta.forEach(function(item) {
    //        //    log.debug(item);
    //        //});
    //
    //        res.status(constants.HTTP_OKAY).send(JSON.stringify(bookmarks));
...
app.post('/system/updatethumbs', function(req, res) {
    ...
    if (req.body && req.body.length > 0) {
        req.body.forEach(function(item) {
            ...
            //dataStore.update(models.BookmarkModel, { 'id': item.id }, {}, { 'thumb': item.thumb }, function(err) {
            //
            //    if (err) {
            //        log.error(err);
            //    }
